...
**Version:** 1.1.x  
**Module:** Akademy Class - SAGE Edu v1.2  
...
- Academic levels and courses,
- Class organization,
- Discipline planning,
- Teacher and student assignments,
- Attendance tracking,
- Evaluation models,
- To official academic reports.
...
#### 🏫 Academic Structure
- Academic levels and areas
- Courses and course–class relationships
- Classes and classrooms
- Lective years and academic quarters

#### 📚 Disciplines & Study Plans
- Disciplines and modalities
- Discipline prerequisites
- Study plans and discipline allocation
- Evaluation metrics linked to study plans

#### 👩‍🏫 Teachers & Lessons
- Teacher assignment to classes and disciplines
- Lesson types and schedules
- Time rules for teachers and classes
- Teacher attendance control

#### 👨‍🎓 Students & Matriculation
- Student enrollment by class and academic year
- Matriculation types and states
- Student attendance tracking

#### 📝 Evaluations
- Evaluation models and types
- Metrics and grading structures
- Discipline-based evaluations

#### 📊 Reports & Documents
- Class and discipline reports
- Study plan reports
